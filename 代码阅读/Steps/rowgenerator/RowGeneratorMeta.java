...
public class RowGeneratorMeta extends BaseStepMeta implements StepMetaInterface
{
    ...
    /*
     * This method is called by PDI whenever a step reads its settings from XML. The XML node containing the step settings
     * is passed in as an argument. Again, the helper class, org.pentaho.di.core.xml.XMLHandler, reads the step
	...
	/*
	 * This method is called by PDI whenever a step serializes its settings to XML. 
	 * It is called when saving a transformation in Spoon. The method returns an XML string containing the serialized step settings. 
	 * The string contains a series of XML tags, one tag per setting. 
	 * The helper class, org.pentaho.di.core.xml.XMLHandler, constructs the XML string.
	 * 
	 * 
	 */
